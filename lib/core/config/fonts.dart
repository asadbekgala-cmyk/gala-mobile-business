...
class AppFonts extends ThemeExtension<AppFonts> {
  final TextStyle fontSize36Weight600;

  final TextStyle fontSize32Weight500;

  final TextStyle fontSize30Weight700;

  final TextStyle fontSize24Weight800;
  ...
  AppFonts({
    required this.fontSize36Weight600,
    required this.fontSize32Weight500,
    required this.fontSize30Weight700,
    required this.fontSize24Weight800,
  ...
  ThemeExtension<AppFonts> lerp(
    ...
    return AppFonts(
      ...
      fontSize24Weight600: fontSize24Weight600,
      fontSize24Weight800: fontSize24Weight800
    );
  }
}
